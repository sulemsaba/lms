...
const VENUE_ALIAS_COORDINATES: Record<string, [number, number]> = {
  "lecture hall 1": [-6.7806, 39.2046],
  "nkrumah lecture theatre": [-6.7805, 39.2046],
  "nkrumah hall": [-6.7805, 39.2046],
  "hall 4": [-6.7815, 39.2045],
  "theater1": [-6.7808, 39.204],
  "theater 1": [-6.7808, 39.204],
  "theater2": [-6.7809, 39.2042],
  "theater 2": [-6.7809, 39.2042],
  "yombo1": [-6.778, 39.202],
  "yombo 1": [-6.778, 39.202],
  "yombo2": [-6.7779, 39.2018],
  "yombo 2": [-6.7779, 39.2018],
  "yombo3": [-6.7778, 39.2017],
  "yombo 3": [-6.7778, 39.2017],
  "yombo4": [-6.7776, 39.2016],
  "yombo 4": [-6.7776, 39.2016],
  "yombo5": [-6.7775, 39.2015],
  "yombo 5": [-6.7775, 39.2015],
  "coaf lr1": [-6.778, 39.204],
  "coaf lr2": [-6.778, 39.204],
  "health lr1": [-6.782, 39.208],
  "health lr 1": [-6.782, 39.208],
  "health lr2": [-6.782, 39.208],
  "health lr 2": [-6.782, 39.208],
  "health lab1": [-6.782, 39.208],
  "health lab 1": [-6.782, 39.208],
  "health lab2": [-6.782, 39.208],
  "health lab 2": [-6.782, 39.208],
  "sc109": [-6.776, 39.206],
  "sc314": [-6.776, 39.206],
  "sc315": [-6.776, 39.206],
  "sc316": [-6.776, 39.206],
  "udbs1": [-6.7845, 39.2025],
  "udbs2": [-6.7845, 39.2025],
  "udbs3": [-6.7845, 39.2025],
  "coict lab 3": [-6.7717, 39.2407],
  "d01 luhanga hall": [-6.7716, 39.2409],
